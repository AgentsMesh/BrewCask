...
class AgentsmeshRunner < Formula
  ...
  on_macos do
    url "https://github.com/AgentsMesh/AgentsMeshRunner/releases/download/v0.1.0/agentsmesh-runner_0.1.0_darwin_all.tar.gz"
    sha256 "2ea73b07c42b0eb10c043f4d10d0dbefa2710669acc7b5468f49b779d3db898c"
  end

  on_linux do
    on_intel do
      url "https://github.com/AgentsMesh/AgentsMeshRunner/releases/download/v0.1.0/agentsmesh-runner_0.1.0_linux_amd64.tar.gz"
      sha256 "7fcbafa0c2a098198719eb594a93d0471613fbc625751bd41413a083ace7eebb"
    end
    on_arm do
      url "https://github.com/AgentsMesh/AgentsMeshRunner/releases/download/v0.1.0/agentsmesh-runner_0.1.0_linux_arm64.tar.gz"
